...
- `src/frontend/sidepanel/index.html`, `src/frontend/sidepanel/sidepanel.css`, `src/frontend/sidepanel/sidepanel.js` — fixed LinkedIn-style panel, official provider controls, dynamic My Groq/My OpenRouter control, and Autopilot controls.
- `src/frontend/options/index.html`, `src/frontend/options/options.css`, `src/frontend/options/options.js` — profile, Official API/Manual API, provider, model, and message settings.
